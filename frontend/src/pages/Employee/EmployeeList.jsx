...
userConfig.dataUrl = '/api/employees/';

const pageConfig = PageConfig();
pageConfig.pageTitle = 'Employee List';
pageConfig.pageButtons = [

];
class EmployeeListListPage extends BaseList {
state = {
    ...userConfig,
    ...pageConfig,
  };
...
export default connect(mapStateToProps)(withRouter(EmployeeListListPage));
